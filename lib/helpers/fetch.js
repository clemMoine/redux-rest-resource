...
exports.parseResponse = exports.buildFetchOpts = exports.buildFetchUrl = exports.HttpError = undefined;
...
var buildFetchUrl = exports.buildFetchUrl = function buildFetchUrl(context, _ref2) {
  ...
  var _splitUrlByProtocolAn = (0, _url.splitUrlByProtocolAndDomain)(url),
      ...
      _splitUrlByProtocolAn3 = _splitUrlByProtocolAn2[0],
      protocolAndDomain = _splitUrlByProtocolAn3 === undefined ? '' : _splitUrlByProtocolAn3,
  ...
  var builtUrl = Object.keys(urlParams).reduce(function (wipUrl, urlParam) {
    ...
    var contextAsObject = !(0, _util.isObject)(context) ? {
      id: context
    } : context;
...
var parseResponse = exports.parseResponse = function parseResponse(res) {
  ...
  var isJson = contentType && ((0, _util.startsWith)(contentType, 'application/json') || (0, _util.endsWith)(contentType.split(';')[0], '+json'));
