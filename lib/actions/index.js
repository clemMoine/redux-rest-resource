...
exports.createActions = exports.createAction = exports.getActionName = undefined;
...
var getActionName = function getActionName(actionId) {
  ...
  return !resourceName ? actionId : '' + (alias || actionId) + (0, _util.ucfirst)(isArray ? resourcePluralName : resourceName);
};
...
var createAction = function createAction(actionId, _ref2) {
  var resourceName = _ref2.resourceName,
      ...
      actionOpts = _objectWithoutProperties(_ref2, ['resourceName', 'resourcePluralName', 'scope', 'stripTrailingSlashes']);
  ...
  return function (context) {
    ...
    return function (dispatch, getState) {
      ...
      var resolvedfetchOpts = Object.keys(fetchOpts).reduce(function (soFar, key) {
        soFar[key] = (0, _util.isFunction)(fetchOpts[key]) ? fetchOpts[key](getState, {
          context: context,
      ...
      var finalFetchUrl = (0, _fetch.buildFetchUrl)(context, {
        url: url,
        urlParams: urlParams,
...
var createActions = function createActions() {
  ...
  return actionKeys.reduce(function (actionFuncs, actionId) {
    ...
    if (globalOpts.url && url && (0, _util.isString)(url) && url.substr(0, 1) === '.') {
      actions[actionId] = _extends({}, actions[actionId], {
    ...
    actionFuncs[actionName] = createAction(actionId, _extends({
      resourceName: resourceName,
      resourcePluralName: resourcePluralName,
      scope: scope
    }, actionOpts));
